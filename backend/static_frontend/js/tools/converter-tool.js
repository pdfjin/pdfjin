...
(function () {
    ...
    const init = () => {
        ...
        executeBtn.addEventListener('click', async () => {
            ...
            // Unified plan limit enforcement
            if (window.PDFJIN_TASKS && typeof window.PDFJIN_TASKS.checkCanProcess === 'function') {
                const limitErr = window.PDFJIN_TASKS.checkCanProcess(totalSizeMB);
                if (limitErr) return window.PDFJIN_TASKS.showBlockModal(limitErr);
            }
            ...
            try {
                ...
                if (window.PDFJIN_TASKS.trackDataUsage) window.PDFJIN_TASKS.trackDataUsage(totalSizeMB);
